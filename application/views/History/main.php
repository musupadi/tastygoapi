                        ...
                        <?php endforeach ?>
                            <div class="box-body">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text"  class="form-control" name="responsible" placeholder="Nama" style="width: 100%;" value="<?php echo $user[0]->name ?>" hint="Person Responsible">
                                <p class="text-red"><?php echo form_error('responsible')?></p>
                              </div>
                              <div class="form-group">
