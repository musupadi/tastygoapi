      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url("Stock")?>"><i class="fa fa-list-alt"></i> <span>Item Stock</span></a></li>
          </ul>
        </li>
        <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu active">
              ...
              <li><a href="<?php echo base_url("Home/Location")?>"><i class="fa fa-map"></i>Location</a></li>
            </ul>
          </li>
        <li class="treeview">
        ...
        <li class="active"><a href="<?php echo base_url("Home/HistoryTransaction")?>"><i class="fa fa-history"></i> <span>Transaction History</span></a></li>
        ...
        <?php if ($data->id_role == 3) : ?>
          <li><a href="<?php echo base_url("Home")?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
          <li><a href="<?php echo base_url("Transaction/trAdminWarehouse")?>"><i class="fa fa-exchange"></i> <span>Transaction</span></a></li>
          <li><a href="<?php echo base_url("Stock/stockAdminWarehouse/" . $data->id)?>"><i class="fa fa-list-alt"></i> <span>Stock</span></a></li>
          <li class="treeview">
            <a href="#">
              <i class="fa fa-briefcase"></i> <span>Master Data</span>
              <span class="pull-right-container">
        ...
        <?php if ($data->id_role == 4) : ?>
          <li><a href="<?php echo base_url("Home")?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
          <li><a href="<?php echo base_url("Transaction/userTransaction")?>"><i class="fa fa-exchange"></i> <span>Transaction</span></a></li>
          <li><a href="<?php echo base_url("Transaction/userRequest")?>"><i class="fa fa-exchange"></i> <span>Transaction History</span></a></li>
          <li><a href="<?php echo base_url("Login/logout")?>"onclick="return confirm('are you going to logout?');"><i class="fa fa-user-times"></i> <span>Sign Out</span></a></li>
        <?php endif ?>
      </ul>
    </section>
