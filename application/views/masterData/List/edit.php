          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                ?>    
                  <?php echo form_open_multipart('Vendor/EditVendor/'.$data->id)?>
                <form role="form" action="<?php echo base_url('Vendor/EditVendor/'.$data->id)?>" method="post" >
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    ...
                    <a href="<?php echo base_url('Vendor/List')?>">Batal</a>
                  </div>
                  <?php } ?>
                </form>
              </div>
